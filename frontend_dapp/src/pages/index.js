  ...
  return (
    <main className="mt-6 " style = {{backgroundImage:"linear-gradient(20deg, blue, green, red)"}}>
      <div className="grid grid-cols-2 pb-6">
        ...
        <div className = "grid-cols-1" style={{backgroundColor:"", paddingLeft:"23%", paddingRight:"10%", paddingTop:"5%", paddingBottom:"5%",}}>
        ...
        <div className = "grid-cols-1 " style={{backgroundColor:"", paddingLeft:"10%", paddingRight:"23%", paddingTop:"5%", paddingBottom:"5%"}}>
