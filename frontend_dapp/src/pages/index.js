  ...
  return (
    <main className="mt-6  mb-6" style = {{transition:"3s ease-in-out"}}>
      <div className="grid grid-cols-2 pb-6" id="firstHomeSection" style={{paddingLeft:"12%", paddingRight:"12%"}}>
        <div className = "grid-cols-1" style={{backgroundColor:"", paddingRight:"10%", paddingTop:"5%", paddingBottom:"5%",}}>
        ...
        <div className = "grid-cols-1 " style={{backgroundColor:"", paddingLeft:"10%", paddingTop:"5%", paddingBottom:"5%"}}>
